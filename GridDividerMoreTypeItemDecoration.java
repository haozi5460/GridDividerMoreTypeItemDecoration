...
/**
 * 区别于GridDividerItemDecoration, 这个适合有HeaderType,在Header下又有图片类型的，在Adapter中item布局可以不使用recyclerView
 *
 * 也就是相当于不需要Recyclerview 嵌套recyclerview了
 */
public class GridDividerMoreTypeItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public GridDividerMoreTypeItemDecoration(Context context, int dividerWidth, boolean isNeedSpace) {
     ...
     * @param isLastRowNeedSpace 最后一行是否需要间隔
     */
    public GridDividerMoreTypeItemDecoration(Context context, int dividerWidth, int firstRowTopMargin, boolean isNeedSpace, boolean isLastRowNeedSpace, @ColorInt int color) {
